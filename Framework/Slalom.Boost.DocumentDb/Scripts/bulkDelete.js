 ...
 */
 function bulkDelete(partitionKey) {
 	...
 	// Validate input.
 	if (!partitionKey) throw new Error("The partitionKey is undefined or null.");
 	...
 	function tryQueryAndDelete(continuation) {
 		...
 		var query = { query: "select * from root r where r.PartitionKey = @partitionKey", parameters: [{ name: "@partitionKey", value: partitionKey }] };
