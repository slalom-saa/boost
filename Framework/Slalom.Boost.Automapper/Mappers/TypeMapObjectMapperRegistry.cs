...
namespace Slalom.Boost.AutoMapper.Mappers
{
    public static class TypeMapObjectMapperRegistry
    {
        ...
        private abstract class PropertyMapMappingStrategy : ITypeMapObjectMapper
        {
            public object Map(ResolutionContext context)
            {
                var mappedObject = this.GetMappedObject(context);
                ...
                {
                    this.MapPropertyValue(context.CreatePropertyMapContext(propertyMap), mappedObject, propertyMap);
                }
                mappedObject = this.ReassignValue(context, mappedObject);
            ...
            private void MapPropertyValue(ResolutionContext context, object mappedObject, PropertyMap propertyMap)
            {
                ...
                {
                    var errorContext = this.CreateErrorContext(context, propertyMap, null);
