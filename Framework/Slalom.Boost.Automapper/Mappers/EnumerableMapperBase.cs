...
namespace Slalom.Boost.AutoMapper.Mappers
{
        ...
        where TEnumerable : IEnumerable
    {
        public object Map(ResolutionContext context)
        {
            ...
            if (this.ShouldAssignEnumerable(context))
            {
            ...
            var destination = this.GetOrCreateDestinationObject(context, destElementType, sourceLength);
            var enumerable = this.GetEnumerableFor(destination);

            this.ClearEnumerable(enumerable);
            ...
            foreach (object item in enumerableValue)
            {
                ...
                this.SetElementValue(enumerable, mappedValue, i);
