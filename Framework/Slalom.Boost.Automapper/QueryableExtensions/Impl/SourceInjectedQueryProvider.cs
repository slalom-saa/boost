...
namespace Slalom.Boost.AutoMapper.QueryableExtensions.Impl
{
    public class SourceInjectedQueryProvider<TSource, TDestination> : IQueryProvider
    {
        ...
        public object Execute(Expression expression)
        {
            ...
            var sourceExpression = this.ConvertDestinationExpressionToSourceExpression(expression);
            var sourceResult = this.InvokeSourceQuery(null, sourceExpression);

            this.Inspector.SourceResult(sourceExpression, sourceResult);
            return sourceResult;
        }
        ...
        public TResult Execute<TResult>(Expression expression)
        {
            ...
            this.Inspector.StartQueryExecuteInterceptor(resultType, expression);
            ...
            var sourceResult = this.InvokeSourceQuery(sourceResultType, sourceExpression);
            ...
            this.Inspector.DestResult(sourceResult);
