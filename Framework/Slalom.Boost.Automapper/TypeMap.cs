...
namespace Slalom.Boost.AutoMapper
{
    ...
    public class TypeMap
    {
        ...
        public int MaxDepth
        {
            ...
            {
                _maxDepth = value;
                this.SetCondition(o => PassesDepthCheck(o, value));
            }
        }
        ...
        public string[] GetUnmappedPropertyNames()
        {
            Func<PropertyMap, string> getFunc =
                pm =>
                    this.ConfiguredMemberList == MemberList.Destination
            ...
            return properties.Where(memberName => !this.IgnorePropertiesStartingWith.Any(memberName.StartsWith)).ToArray();
        }

        public PropertyMap FindOrCreatePropertyMapFor(IMemberAccessor destinationProperty)
        {
            var propertyMap = this.GetExistingPropertyMapFor(destinationProperty);
        ...
        public void IncludeDerivedTypes(Type derivedSourceType, Type derivedDestinationType)
        {
            ...
            if(derivedTypes.Equals(this.Types))
            {
        ...
        public Type GetDerivedTypeFor(Type derivedSourceType)
        {
            ...
            return this.DestinationTypeOverride ?? match?.DestinationType ?? this.DestinationType;
        }
        ...
        {
            return _includedDerivedTypes.Any() || this.DestinationTypeOverride != null;
        }
        ...
        {
            return (this.CustomMapper == null && this.CustomProjection == null &&
                    this.DestinationTypeOverride == null);
        }
        ...
        private void ApplyInheritedTypeMap(TypeMap inheritedTypeMap)
        {
            ...
            {
                var conventionPropertyMap = this.GetPropertyMaps()
                    .SingleOrDefault(m =>
                ...
                else if (conventionPropertyMap == null)
                {
                    ...
                    this.AddInheritedPropertyMap(propertyMap);
                }
            }
        ...
        {
            var ctorExpr = this.ConstructExpression;
            if(ctorExpr != null)
            {
                return ctorExpr;
            }
            Expression newExpression;
            if(this.ConstructorMap != null && this.ConstructorMap.CtorParams.All(p => p.CanResolve))
            {
                newExpression = this.ConstructorMap.NewExpression(instanceParameter);
            }
            else
            {
                newExpression = Expression.New(this.DestinationTypeOverride ?? this.DestinationType);
            }
