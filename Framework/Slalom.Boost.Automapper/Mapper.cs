...
namespace Slalom.Boost.AutoMapper
{
    ...
    public class Mapper : IMapper, IDynamicMapper
    {
        ...
        {
            return ((IMapper)this).Map<TDestination>(source, this.DefaultMappingOptions);
        }
        ...
        TDestination IMapper.Map<TSource, TDestination>(TSource source)
        {
            ...
            return (TDestination)((IMapper)this).Map(source, modelType, destinationType, this.DefaultMappingOptions);
        }
            ...
            Action<IMappingOperationOptions<TSource, TDestination>> opts)
        {
            ...
            return (TDestination)this.MapCore(source, modelType, destinationType, options);
        }

        TDestination IMapper.Map<TSource, TDestination>(TSource source, TDestination destination)
        {
            return ((IMapper)this).Map(source, destination, this.DefaultMappingOptions);
        }
            ...
            Action<IMappingOperationOptions<TSource, TDestination>> opts)
        {
            ...
            return (TDestination)this.MapCore(source, destination, modelType, destinationType, options);
        }

        object IMapper.Map(object source, Type sourceType, Type destinationType)
        {
            return ((IMapper)this).Map(source, sourceType, destinationType, this.DefaultMappingOptions);
        }
        ...
        object IMapper.Map(object source, Type sourceType, Type destinationType, Action<IMappingOperationOptions> opts)
        {
            ...
            return this.MapCore(source, sourceType, destinationType, options);
        }

        object IMapper.Map(object source, object destination, Type sourceType, Type destinationType)
        {
            return ((IMapper)this).Map(source, destination, sourceType, destinationType, this.DefaultMappingOptions);
        }
            ...
            Action<IMappingOperationOptions> opts)
        {
            ...
            return this.MapCore(source, destination, sourceType, destinationType, options);
        }
