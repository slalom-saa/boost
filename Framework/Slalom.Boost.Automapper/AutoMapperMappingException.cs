        ...
        public override string Message
        {
            get
            {
                ...
                if (this.Types != null)
                {
                    ...
                    message += newLine +
                               $"{this.Types.SourceType.Name} -> {this.Types.DestinationType.Name}";
                    message += newLine +
                               $"{this.Types.SourceType.FullName} -> {this.Types.DestinationType.FullName}";
                }
                if (this.Context != null)
                { 
                    var destPath = this.GetDestPath(this.Context);
                    message += newLine + newLine + "Destination path:" + newLine + destPath;

                    message += newLine + newLine + "Source value:" + newLine + (this.Context.SourceValue ?? "(null)");
