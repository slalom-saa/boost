...
namespace Slalom.Boost.AutoMapper
{
    ...
    public abstract class Profile : IProfileExpression, IProfileConfiguration
    {
        ...
        protected Profile()
        {
            this.ProfileName = this.GetType().FullName;
            ...
            this.ShouldMapProperty = p => p.IsPublic();
            this.ShouldMapField = f => f.IsPublic;
            _mapMissingTypes = new ConditionalObjectMapper(this.ProfileName) {Conventions = {tp => true}};
            ...
            get
        {
                ...
                this.DefaultMemberConfig.AddMember<NameSplitMember>(_ => convention = _.SourceMemberNamingConvention);
                return convention;
        }
            set { this.DefaultMemberConfig.AddMember<NameSplitMember>(_ => _.SourceMemberNamingConvention = value); }
        }
        ...
        {
                INamingConvention convention = null;
                this.DefaultMemberConfig.AddMember<NameSplitMember>(_ => convention = _.DestinationMemberNamingConvention);
                return convention;
        }
            set { this.DefaultMemberConfig.AddMember<NameSplitMember>(_ => _.DestinationMemberNamingConvention = value); }
        }
        ...
        {
            _configurator.ForAllMaps(this.ProfileName, configuration);
        }
        ...
        {
            return _configurator.CreateMap<TSource, TDestination>(this.ProfileName, memberList);
        }
        ...
        {
            var map = _configurator.CreateMap(sourceType, destinationType, memberList, this.ProfileName);
        ...
        {
            this.DefaultMemberConfig.AddName<PrePostfixName>(_ => _.Prefixes.Clear());
        }

        public void RecognizeAlias(string original, string alias)
        {
            this.DefaultMemberConfig.AddName<ReplaceName>(_ => _.AddReplace(original, alias));
        }

        public void ReplaceMemberName(string original, string newValue)
        {
            this.DefaultMemberConfig.AddName<ReplaceName>(_ => _.AddReplace(original, newValue));
        }

        public void RecognizePrefixes(params string[] prefixes)
        {
            this.DefaultMemberConfig.AddName<PrePostfixName>(_ => _.AddStrings(p => p.Prefixes, prefixes));
        }

        public void RecognizePostfixes(params string[] postfixes)
        {
            this.DefaultMemberConfig.AddName<PrePostfixName>(_ => _.AddStrings(p => p.Postfixes, postfixes));
        }

        public void RecognizeDestinationPrefixes(params string[] prefixes)
        {
            this.DefaultMemberConfig.AddName<PrePostfixName>(_ => _.AddStrings(p => p.DestinationPrefixes, prefixes));
        }

        public void RecognizeDestinationPostfixes(params string[] postfixes)
        {
            this.DefaultMemberConfig.AddName<PrePostfixName>(_ => _.AddStrings(p => p.DestinationPostfixes, postfixes));
        }
        ...
        {
            var condition = new ConditionalObjectMapper(this.ProfileName);
