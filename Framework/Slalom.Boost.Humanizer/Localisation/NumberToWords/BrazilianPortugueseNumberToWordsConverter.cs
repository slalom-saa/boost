...
namespace Slalom.Boost.Humanizer.Localisation.NumberToWords
{
    internal class BrazilianPortugueseNumberToWordsConverter : GenderedNumberToWordsConverter
    {
        ...
        public override string Convert(int number, GrammaticalGender gender)
        {
            ...
            if (number < 0)
                return string.Format("menos {0}", this.Convert(Math.Abs(number), gender));
            ...
            if ((number / 1000000000) > 0)
            {
                ...
                parts.Add(number / 1000000000 > 2
                    ? string.Format("{0} bilhões", this.Convert(number / 1000000000, GrammaticalGender.Masculine))
                    : string.Format("{0} bilhão", this.Convert(number / 1000000000, GrammaticalGender.Masculine)));
            ...
            if ((number / 1000000) > 0)
            {
                ...
                parts.Add(number / 1000000 > 2
                    ? string.Format("{0} milhões", this.Convert(number / 1000000, GrammaticalGender.Masculine))
                    : string.Format("{0} milhão", this.Convert(number / 1000000, GrammaticalGender.Masculine)));
            ...
            if ((number / 1000) > 0)
            {
                ...
                parts.Add(number / 1000 == 1 ? "mil" : string.Format("{0} mil", this.Convert(number / 1000, GrammaticalGender.Masculine)));
                number %= 1000;
            }
        ...
        public override string ConvertToOrdinal(int number, GrammaticalGender gender)
        {
            ...
            if ((number / 1000000000) > 0)
            {
                parts.Add(number / 1000000000 == 1
                    ...
                    : string.Format("{0} " + ApplyOrdinalGender("bilionésimo", gender), this.ConvertToOrdinal(number / 1000000000, gender)));
            ...
            if ((number / 1000000) > 0)
            {
                parts.Add(number / 1000000 == 1
                    ...
                    : string.Format("{0}" + ApplyOrdinalGender("milionésimo", gender), this.ConvertToOrdinal(number / 1000000000, gender)));
            ...
            if ((number / 1000) > 0)
            {
                parts.Add(number / 1000 == 1
                    ...
                    : string.Format("{0} " + ApplyOrdinalGender("milésimo", gender), this.ConvertToOrdinal(number / 1000, gender)));
