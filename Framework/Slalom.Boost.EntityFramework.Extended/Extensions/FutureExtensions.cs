...
using Slalom.Boost.EntityFramework.Extensions.Future;

namespace Slalom.Boost.EntityFramework.Extensions.Extensions
{
    /// <summary>
    /// Extension methods for future queries.
    /// </summary>
    /// <seealso cref="T:Slalom.Boost.EntityFramework.Extensions.Future.FutureQuery`1"/>
    /// <seealso cref="T:Slalom.Boost.EntityFramework.Extensions.Future.FutureValue`1"/>
    /// <seealso cref="T:Slalom.Boost.EntityFramework.Extensions.Future.FutureCount"/>
    public static class FutureExtensions
    {
        ...
        /// </summary>
        /// <typeparam name="TEntity">The type of the elements of <paramref name="source" />.</typeparam>
        /// <typeparam name="TResult">The type of the result value wrapped in a <see cref="T:Slalom.Boost.EntityFramework.Extensions.Future.FutureValue`1"/>.</typeparam>
        /// <param name="source">An <see cref="T:System.Linq.IQueryable`1" /> to add to the batch of future queries.</param>
        /// <param name="selector">A lambda expression with one of the Min, Max, Count, Sum, Average aggregate functions</param>
        /// <returns>An instance of <see cref="T:Slalom.Boost.EntityFramework.Extensions.Future.FutureValue`1" /> that contains the result of the query</returns>
