...
namespace Slalom.Boost.EntityFramework.Extensions.Future
{
    /// <summary>
    ...
    public class FutureValue<T> : FutureQueryBase<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Slalom.Boost.EntityFramework.Extensions.Future.FutureValue`1"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="T:Slalom.Boost.EntityFramework.Extensions.Future.FutureValue`1" /> to T.
        /// </summary>
