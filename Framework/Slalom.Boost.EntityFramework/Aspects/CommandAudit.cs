...
namespace Slalom.Boost.EntityFramework.Aspects
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Commands.CommandAudit"/> class.
        /// </summary>
        public CommandAudit()
        {
        }
        ...
        public CommandAudit(ICommand command, CommandResult result)
        {
            ...
            {
                this.ValidationMessages = String.Join("; ",
                    result.ValidationMessages.Select(e => $"{e.MessageType}: {e.Message}"));
            }
            ...
            try
            {
                this.AdditionalInformation = JsonConvert.SerializeObject(result.Context.AdditionalData);
            }
            catch
            {
            }
