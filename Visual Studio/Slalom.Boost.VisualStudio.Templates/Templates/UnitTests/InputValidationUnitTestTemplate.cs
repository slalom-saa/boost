...
{
    public class InputValidationUnitTestTemplate : Template
    {
        private static readonly string TemplateContent = Files.InputValidationUnitTestTemplate;

        public InputValidationUnitTestTemplate()
            : base("InputValidationUnitTest", TemplateContent)
        {
        }
