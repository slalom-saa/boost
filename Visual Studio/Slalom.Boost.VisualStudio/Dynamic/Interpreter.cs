...
using Slalom.Boost.VisualStudio.Dynamic.Visitors;
...
namespace Slalom.Boost.VisualStudio.Dynamic
{
	...
	public class Interpreter
	{
		...
		public Interpreter(InterpreterOptions options)
		{
			...
			{
				this.SetIdentifiers(LanguageConstants.Literals);
			}

			if ((options & InterpreterOptions.PrimitiveTypes) == InterpreterOptions.PrimitiveTypes)
			{
				this.Reference(LanguageConstants.PrimitiveTypes);
				this.Reference(LanguageConstants.CSharpPrimitiveTypes);
			}

			if ((options & InterpreterOptions.CommonTypes) == InterpreterOptions.CommonTypes)
			{
				this.Reference(LanguageConstants.CommonTypes);
			}
		...
		{
			var visitor = this.Visitors.FirstOrDefault(p => p is DisableReflectionVisitor);
			if (visitor != null)
		...
		public Interpreter SetVariable(string name, object value)
		{
			...
			return this.SetExpression(name, Expression.Constant(value));
		}
		...
		public Interpreter SetVariable(string name, object value, Type type)
		{
			...
			return this.SetExpression(name, Expression.Constant(value, type));
		}
		...
		{
			return this.SetIdentifier(new Identifier(name, expression));
		}
		...
		public Interpreter Reference(Type type)
		{
			...
			return this.Reference(type, type.Name);
		}
		...
		{
			return this.Reference(new ReferenceType(typeName, type));
		}
		...
		{
			return this.Parse(expressionText, typeof(void), parameters);
		}
		...
		{
			return this.ParseAsLambda(expressionText, expressionType, parameters);
		}
		...
		{
			return this.ParseAsDelegate<TDelegate>(expressionText, parametersNames);
		}
		...
		{
			var lambda = this.ParseAs<TDelegate>(expressionText, parametersNames);
		...
		public Lambda ParseAs<TDelegate>(string expressionText, params string[] parametersNames)
		{
			...
			return this.ParseAsLambda(expressionText, delegateInfo.ReturnType, delegateInfo.Parameters);
		}
		#endregion
		...
		{
			return this.Eval(expressionText, typeof(void), parameters);
		}
		...
		{
			return (T)this.Eval(expressionText, typeof(T), parameters);
		}
		...
		{
			return this.Parse(expressionText, expressionType, parameters).Invoke(parameters);
		}
		#endregion
