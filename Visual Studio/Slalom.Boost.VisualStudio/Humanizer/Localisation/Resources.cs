...
namespace Slalom.Boost.VisualStudio.Humanizer.Localisation
{
    /// <summary>
    ...
    {
        static readonly ResourceManager ResourceManager = new ResourceManager("Humanizer.Properties.Resources", typeof(Resources).GetTypeInfo().Assembly);
