...
namespace Slalom.Boost.VisualStudio.Humanizer.Localisation.NumberToWords
{
    internal class FinnishNumberToWordsConverter : GenderlessNumberToWordsConverter
    {
        ...
        {
            if (number < 0)
                return string.Format("miinus {0}", this.Convert(-number));
            ...
            if ((number / 1000000000) > 0)
            {
                parts.Add(number / 1000000000 == 1
                    ? "miljardi "
                    : string.Format("{0}miljardia ", this.Convert(number / 1000000000)));
            ...
            if ((number / 1000000) > 0)
            {
                parts.Add(number / 1000000 == 1
                    ? "miljoona "
                    : string.Format("{0}miljoonaa ", this.Convert(number / 1000000)));
            ...
            if ((number / 1000) > 0)
            {
                parts.Add(number / 1000 == 1
                    ? "tuhat "
                    : string.Format("{0}tuhatta ", this.Convert(number / 1000)));
            ...
            if ((number / 100) > 0)
            {
                parts.Add(number / 100 == 1
                    ? "sata"
                    : string.Format("{0}sataa", this.Convert(number / 100)));
            ...
            {
                parts.Add(string.Format("{0}kymmentä", this.Convert(number / 10)));
                number %= 10;
            }
        ...
        private string ToOrdinal(int number, bool useExceptions)
        {
            ...
            if ((number / 1000000000) > 0)
            {
                parts.Add(string.Format("{0}miljardis", (number / 1000000000) == 1 ? "" : this.ToOrdinal(number / 1000000000, true)));
                number %= 1000000000;
            }

            if ((number / 1000000) > 0)
            {
                parts.Add(string.Format("{0}miljoonas", (number / 1000000) == 1 ? "" : this.ToOrdinal(number / 1000000, true)));
                number %= 1000000;
            }

            if ((number / 1000) > 0)
            {
                parts.Add(string.Format("{0}tuhannes", (number / 1000) == 1 ? "" : this.ToOrdinal(number / 1000, true)));
                number %= 1000;
            }

            if ((number / 100) > 0)
            {
                parts.Add(string.Format("{0}sadas", (number / 100) == 1 ? "" : this.ToOrdinal(number / 100, true)));
                number %= 100;
            }

            if (number >= 20 && (number / 10) > 0)
            {
                parts.Add(string.Format("{0}kymmenes", this.ToOrdinal(number / 10, true)));
                number %= 10;
            }
            else if (number > 10 && number < 20)
                parts.Add(string.Format("{0}toista", this.GetOrdinalUnit(number % 10, true)));
