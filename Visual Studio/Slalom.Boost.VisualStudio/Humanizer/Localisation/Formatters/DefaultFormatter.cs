...
namespace Slalom.Boost.VisualStudio.Humanizer.Localisation.Formatters
{
    ...
    public class DefaultFormatter : IFormatter
    {
        ...
        {
            return this.Format(ResourceKeys.DateHumanize.Never);
        }
        ...
        private string GetResourceForDate(TimeUnit unit, Tense timeUnitTense, int count)
        {
            ...
            return count == 1 ? this.Format(resourceKey) : this.Format(resourceKey, count);
        }
        ...
        {
            return Resources.GetResource(this.GetResourceKey(resourceKey), _culture);
        }
        ...
        {
            return Resources.GetResource(this.GetResourceKey(resourceKey, number), _culture).FormatWith(number);
        }
